...
<script>
	function showMenu() {
		$('.ui.bottom.sidebar').sidebar('setting', 'transition', 'overlay').sidebar('toggle');
	}
</script>
<head>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
            	<!-- Notification Comment for Future Purpose -->
                <!-- <li class="dropdown">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell"></i>
                    	<sup><span class="badge badge-bgcolor">7</span></sup>
                    <b class="caret"></b>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Parthi <b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="charts.html"><i class="fa fa-fw fa-hand-o-up"></i> Doubts</a>
                    </li>
                    <!--<li>
                        <a href="tables.html"><i class="fa fa-fw fa-table"></i> Tables</a>
                    </li>-->
                    <li>
                        <a href="forms.html"><i class="fa fa-fw fa-edit"></i> Tests</a>
                    </li>
                    <!--<li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<!--<button class="ui button" data-transition="overlay" onclick="showMenu()">
				  Button
				</button>-->
                <!-- Chart -->
                <!--<div class="row">
